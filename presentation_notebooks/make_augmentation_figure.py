...
ax.text(50, 97, "Spectrogram data augmentation",
        ha="center", va="center", fontsize=18.3, color=INK)
...
ax.text(4, 84.7, "7× per reference clip, all target classes",
        ha="left", va="center", fontsize=11.0, color=INK, style="italic")
...
for i, (title, body, mult) in enumerate(cards):
    ...
    ax.text(x + cw / 2, cy + ch / 2 - 1.3, body, ha="center", va="center",
            fontsize=9.3, color=INK, linespacing=1.3)
...
ax.text(50, 60.5, "= 7 variants per reference clip",
        ha="center", va="center", fontsize=11.0, color=INK, style="italic")
...
ax.text(ox + ow / 2, yt + 2.2, "Colobus reference clip", ha="center",
        va="bottom", fontsize=10.4, color=INK)
ax.text(ox - 1.2, yb, "20 Hz", ha="right", va="center", fontsize=8.5, color=INK)
ax.text(ox - 1.2, yd, "1.5 kHz", ha="right", va="center", fontsize=8.5, color=INK)
ax.text(ox - 1.2, yt, "8 kHz", ha="right", va="center", fontsize=8.5, color=INK)
...
ax.text(ox + ow + 7, yb + SPEC_H / 2 + 2.2, "replace\nhigh band", ha="center",
        va="bottom", fontsize=8.8, color=INK, style="italic", linespacing=1.1)
...
ax.text(ax2 + aw + 2, yd2 + 0.5 * (yt2 - yd2),
        ...
        fontsize=9.3, color=INK, linespacing=1.2)
