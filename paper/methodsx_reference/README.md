# MethodsX submission reference material
...
| File | What it is |
|------|------------|
| `MethodsX_Guide_for_Authors.pdf` | Official MethodsX Guide for Authors. Key rules: abstract ≤ 250 words (the method-article template caps it at 200 incl. bullets); ≤ 25 references; mandatory sections (Specifications table, Background, Method details, Method validation, Ethics, CRediT, etc.). |
