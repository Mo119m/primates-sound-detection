...
def main():
    ...
    ap.add_argument("--drop-extra-confuser", action="store_true",
                    help="Ablation: drop the 253 reviewed deployment detections "
                         "added to Colobus_confuser, leaving the original 654. "
                         "Those 253 are all Colobus-channel false positives, so "
                         "adding them pushes the model to be more conservative "
